...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GEM.IQ — Executive assessments for global readiness" },
      ...
      { property: "og:title", content: "GEM.IQ — Executive assessments for global readiness" },
      ...
      { name: "twitter:title", content: "GEM.IQ — Executive assessments for global readiness" },
